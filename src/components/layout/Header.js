    ...
    header.innerHTML = `
      <div class="container mx-auto px-4 flex justify-between items-center h-full">
        ...
        <nav class="hidden md:flex items-center gap-8">
          ...
          <a href="#maintenance" class="nav-link flex items-center gap-2 text-gray-700 hover:text-blue-600 transition-colors">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div id="dropdown-menu" class="hidden fixed top-16 right-4 w-80 max-w-[90%] bg-white shadow-lg rounded-lg p-0 z-50" style="flex-direction: column;">
        ...
        <div class="flex flex-col py-2">
          ...
          <a href="#maintenance" class="nav-link flex items-center gap-3 px-6 py-3 text-gray-700 hover:bg-blue-50 hover:text-blue-600 transition-colors">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
